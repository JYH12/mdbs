...
<%@ include file="header.jsp" %>
	...
	<div class="main w clearfix">
		<div class="m-left">
			<%-- <div class="user-image"><img src="/images/${user.headUrl}"></div>
			<div class="user-info">
			...
			<div class="user-post">
				<div class="user-post-title"><span></span>&nbsp;备份计划列表</div>
				<a href="createbp.do">创建备份计划</a>
				<ul class="user-post-list">
					<c:forEach items="${baPlans}" var="plan">
						<li>
							<span class="glyphicon glyphicon-file"></span>&nbsp;
							<a href="bplan.do?bid=${plan.bid}">${plan.planName}</a>
							<span class="user-post-time">创建于 ${plan.createTime}</span>
						</li>
					</c:forEach>
				</ul>
			</div>
